...
export function HeroSection() {
    return (
        <section className='grid md:grid-cols-5 gap-0 h-screen'>
            ...
            <div className='md:col-span-3 bg-secondary-700 md:pl-20 max-md:justify-center'>
                <div className='grid md:grid-cols-3 grid-cols-1 my-auto max-md:text-center relative' style={{ marginTop:'20%' }} >
                    ...
                    <div className='mt-20 md:col-span-3  w-full'>
                        <div className='grid grid-cols-4 max-md:grid-cols-2 gap-4 border-t-2 border-solid border-secondary-100 pt-10'>
                            <div>
            ...
            <div className='absolute w-1/6 opacity-75 bottom-5 left-1/2 transform -translate-x-1/2 '>
                <img className='animate-pulse md:w-1/3 w-16 fa fa-arrow-down' src={scrollDown} />
            </div>
        </section>
    );
} 